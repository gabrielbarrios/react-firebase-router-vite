...
const FormInput = forwardRef(({ type, placeholder, onChange, onBlur, name, label, error, children, value }, ref) => {
    ...
    return (
        <div className="mb-6">
            <label htmlFor={name} className={errorClassLabel}>{label}</label>
            <input
